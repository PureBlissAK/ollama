...
class IssueClassifier:
    ...
    TYPE_PATTERNS = {
        ...
        'feature': {
            'keywords': [
                ...
                'support', 'request', 'would be nice', 'could you', 'please add'
            ],
            'title_patterns': [
                r'\[feature\]',
                r'\[enhancement\]',
        ...
        'documentation': {
            'keywords': [
                'documentation', 'docs', 'readme', 'typo', 'spelling',
                'grammar', 'example', 'tutorial', 'guide', 'explain', 'clarify'
            ],
            'title_patterns': [
                r'\[docs\]',
                r'docs:',
        ...
        'question': {
            'keywords': [
                'question', 'how to', 'how do i', 'help', 'confused',
                'what is', 'why does', 'clarification', 'understand'
            ],
            'title_patterns': [
                r'\[question\]',
                r'\?$',
        ...
        'security': {
            'keywords': [
                'security', 'vulnerability', 'exploit', 'cve', 'attack',
                'malicious', 'injection', 'xss', 'csrf', 'authentication',
                'authorization', 'leak', 'exposure', 'sensitive'
            ],
            'title_patterns': [
                r'\[security\]',
                r'security:',
        ...
        'performance': {
            'keywords': [
                'performance', 'slow', 'optimization', 'speed', 'latency',
                'throughput', 'memory', 'cpu', 'bottleneck', 'timeout'
            ],
            'title_patterns': [
                r'\[performance\]',
                r'performance:',
    ...
    PRIORITY_PATTERNS = {
        'p0': {
            'keywords': [
                'critical', 'urgent', 'production down', 'outage', 'breaking',
                'crash', 'data loss', 'security', 'vulnerability', 'exploit',
                'emergency', 'asap', 'immediately'
            ],
            'impact_indicators': [
                'production', 'all users', 'everyone', 'complete failure',
                'total loss', 'cannot use', 'unusable'
            ],
            'score': 100,
        },
        'p1': {
            'keywords': [
                'important', 'high priority', 'blocker', 'blocking',
                'major', 'significant', 'severe', 'serious'
            ],
            'impact_indicators': [
                'many users', 'multiple', 'common', 'frequent',
        ...
        'p2': {
            'keywords': [
                'medium', 'normal', 'moderate', 'standard',
                'regular', 'typical'
            ],
            'impact_indicators': [
                'some users', 'edge case', 'workaround exists',
                'minor inconvenience'
            ],
            'score': 50,
        },
        'p3': {
            'keywords': [
                'low', 'minor', 'trivial', 'nice to have',
                'eventually', 'someday', 'enhancement', 'improvement'
            ],
            'impact_indicators': [
                'rare', 'uncommon', 'cosmetic', 'polish',
    ...
    TEAM_PATTERNS = {
        'backend': [
            'api', 'server', 'database', 'sql', 'query', 'endpoint',
            'authentication', 'authorization', 'rest', 'graphql'
        ],
        'frontend': [
            'ui', 'ux', 'interface', 'css', 'html', 'react', 'vue',
            'angular', 'component', 'button', 'form', 'layout'
        ],
        'devops': [
            'deployment', 'ci/cd', 'docker', 'kubernetes', 'terraform',
            'infrastructure', 'cloud', 'gcp', 'aws', 'monitoring'
        ],
        'security': [
            'security', 'vulnerability', 'authentication', 'authorization',
            'encryption', 'ssl', 'tls', 'firewall', 'attack'
        ],
        'data': [
            'analytics', 'metrics', 'data', 'statistics', 'reporting',
            'dashboard', 'visualization', 'etl', 'pipeline'
        ],
    }
