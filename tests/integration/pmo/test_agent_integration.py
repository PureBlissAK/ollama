...
class TestPMOAgentIntegration:
    ...
    def test_github_api_connection(self, test_repo: str, github_token: str, temp_repo_path: Path):
...
class TestPMOAgentErrorHandling:
    ...
    def test_missing_pmo_yaml(self, test_repo: str, github_token: str, tmp_path: Path):
...
class TestPMOAgentPerformance:
    ...
    def test_label_setup_performance(self, test_repo: str, github_token: str, temp_repo_path: Path):
