...
class TestAuthSchema:
    ...
    def test_user_registration_schema(self):
        ...
        from ollama.api.schemas.auth import UserCreate
    ...
    def test_login_schema(self):
        ...
        from ollama.api.schemas.auth import LoginRequest
    ...
    def test_token_response_schema(self):
        ...
        from ollama.api.schemas.auth import TokenResponse
    ...
    def test_api_key_schema(self):
        """Test API key schema"""
        from ollama.api.schemas.auth import APIKeyCreate
