...
from ollama.services.ollama_client import OllamaClient, GenerateRequest, ChatRequest, ChatMessage
...
class TestOllamaClientSingleton:
    ...
    def test_init_ollama_client(self):
        ...
        from ollama.services.ollama_client import init_ollama_client
