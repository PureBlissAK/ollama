...
class TestMetricsCollection:
    ...
    def test_request_count_metric_exists(self):
        ...
        assert 'http_requests' in REQUEST_COUNT._name or REQUEST_COUNT._name == 'http_requests_total'
    ...
    def test_auth_metrics_exist(self):
        ...
        assert 'auth_attempts' in AUTH_ATTEMPTS._name or AUTH_ATTEMPTS._name == 'auth_attempts_total'
